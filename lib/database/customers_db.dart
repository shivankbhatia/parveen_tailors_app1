...
class CustomersDB {
  ...
  Future<Database> openDB() async {
    ...
    String DBpath = join(appDir.path, "customersDB2.db");
    ...
    return await openDatabase(DBpath, onCreate: (db, version) {
      ...
      db.execute(
          "create table $TABLE_NOTE ( $COLUMN_NOTE_SNO integer primary key autoincrement, $COLUMN_NOTE_TITLE text, $COLUMN_NOTE_DESC text, $COLUMN_MEAS_SHIRTL text, $COLUMN_MEAS_SHIRTC text, $COLUMN_MEAS_SHIRTT text, $COLUMN_MEAS_SHIRTB text, $COLUMN_MEAS_SHIRTG text, $COLUMN_MEAS_SHIRTS text, $COLUMN_MEAS_KURTAL text, $COLUMN_MEAS_KURTAH text, $COLUMN_MEAS_KURTAM text, $COLUMN_MEAS_PANTL text,  $COLUMN_MEAS_PANTK text, $COLUMN_MEAS_PANTH text, $COLUMN_MEAS_PANTP text,  $COLUMN_MEAS_PANTA text, $COLUMN_MEAS_PANTM text, $COLUMN_MEAS_PANTBP text, $COLUMN_NOTE_ADDITIONAL text)");
      // n...
    }, version: 1);
  }
